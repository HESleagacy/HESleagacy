...
and infrastructure that actually survives contact with users.
...
- Cloud-native tooling (Docker, Kubernetes basics)
- Clean open-source collaboration practices
...
- Model training, inference pipelines, serialization
